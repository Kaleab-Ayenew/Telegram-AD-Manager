"""
Django settings for tg_ad_manager project.
...
ROOT_URLCONF = 'tg_ad_manager.urls'
...
WSGI_APPLICATION = 'tg_ad_manager.wsgi.application'
...
EMAIL_HOST = env('VERIFY_EMAIL_HOST')
EMAIL_PORT = int(env('VERIFY_EMAIL_PORT'))
EMAIL_USE_TLS = False
EMAIL_HOST_USER = env('VERIFY_EMAIL_HOST_USER')
